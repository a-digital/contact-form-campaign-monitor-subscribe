...
namespace adigital\contactformcampaignmonitorsubscribe;
 ...
 */
class ContactFormCampaignMonitorSubscribe extends Plugin
{
    // Static Properties
    // =========================================================================
     ...
     * ContactFormCampaignMonitorSubscribe::$plugin
     *
     * @var ContactFormCampaignMonitorSubscribe
     */
 ...
 */
    ...
    protected function settingsHtml(): string
    {
        return Craft::$app->view->renderTemplate(
            'contact-form-campaign-monitor-subscribe/settings',
            [
                'settings' => $this->getSettings()
            ]
        );
